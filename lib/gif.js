...
function GifManager(gifs, context) {
    ...
    this.background = function() {
        if( typeof base == 'undefined' || !!! base ) return false
        ...
        console.log(base.width, base.height, new_width, new_height, cropping)

        var offset_width = (base.width - new_width) / 2
        var offset_height = (base.height - new_height) / 2

        console.log( offset_width, offset_height, 500, 500)
        context.drawImage(
            base,
